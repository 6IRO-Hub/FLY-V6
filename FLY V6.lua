...
speed.Name --[[==================================================================]] = "speed"
speed.Parent = Frame
speed.BackgroundColor3 =
    Color3.fromRGB --[[==================================================================]](50, 50, 50)
speed.BorderColor3 = Color3.fromRGB(255, 255, 255)
speed --[[====================================================================]].Position =
    UDim2.new(0.468421042, 0, 0.491228074, 0)
...
mini2.Parent = Frame
mini2.BackgroundColor3 = Color3.fromRGB --[[====================================]](50, 50, 50)
...
onof.MouseButton1Click:connect(
    function()
        if (nowe == true) then
            nowe = false
...
up.MouseButton1Down:connect(
    function()
        tis =
            up.MouseEnter:connect(
            function()
                while tis do
                    wait()
                    speaker.Character.HumanoidRootPart.CFrame =
...
mini2.MouseButton1Click:Connect(
    function()
        up.Visible = true
        down.Visible = true
        onof.Visible = true
